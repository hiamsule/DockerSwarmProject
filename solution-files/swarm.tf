...
locals {
  github-repo     = "https://github.com/james-clarusway/phonebookapp.git"
  github-file-url = "https://raw.githubusercontent.com/james-clarusway/phonebookapp/main/"
}
...
variable "mykey" {
  default = "clarus"  # change the key name
}
